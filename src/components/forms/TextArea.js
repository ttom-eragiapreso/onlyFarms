...
const TextArea = forwardRef(({ 
  ...
  const baseTextAreaClasses = "w-full px-4 py-3 border transition-all duration-200 text-gray-900 placeholder:text-gray-500 resize-none";
  ...
  const textAreaClasses = `${baseTextAreaClasses} ${variantClasses[variant]} ${errorClasses} ${className}`;
